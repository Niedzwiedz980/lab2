import math
#zadanie1
listaSportow = ["Piłka nożna","Koszykówka","Baseball"]
listaSportow.reverse()
listaSportow.append("Siatkówka")
listaSportow.append("Tenis")
listaSportow.append("Piłka ręczna")

#zadanie2

slownikSkrotow = {"wgl":"W ogóle","min":"między innymi","ok":"okej","db":"dobrze"}

#zadanie3

ulubioneGry = {"ETS 2":"Simulator","FS22":"Simulator","My Summer Car":"Simulator"}
print("liczba ulubionych gier to: " + str(len(ulubioneGry)))

#zadanie4

# zdanie = input("Wpisz zdanie potrzebengo do policzenia w nim litery 'a'")
# print("ilość litery 'a' w zdanie to: "+str(zdanie.count('a')))

#zadanie5

odczyt = open("wejscie","r")
